import 'package:ac_code_metrics/src/utils/path_utils.dart';
...
void main() {
  group('uriToPath returns', () {
    ...
    test('null for passed null', () {
      expect(
        uriToPath(
          Uri.parse('package:ac_code_metrics/src/utils/path_utils.dart'),
        ),
        equals(p.absolute('ac_code_metrics/src/utils/path_utils.dart')),
      );
    });
  });
}
