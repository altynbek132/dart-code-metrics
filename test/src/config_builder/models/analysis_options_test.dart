...
import 'package:ac_code_metrics/src/utils/analyzer_utils.dart';
...
void main() {
  ...
  group('analysisOptionsFromFile constructs AnalysisOptions from', () {
    ...
    test('yaml file', () {
      ...
      expect(options.options, contains('ac_code_metrics'));
      expect(options.options['ac_code_metrics'], contains('metrics'));
      expect(
        (options.options['ac_code_metrics']
      ...
      expect(options.options, contains('ac_code_metrics'));
      expect(options.options['ac_code_metrics'], contains('metrics-exclude'));
      expect(
        (options.options['ac_code_metrics']
      ...
      expect(options.options['ac_code_metrics'], contains('rules'));
      expect(
        (options.options['ac_code_metrics'] as Map<String, Object>)['rules'],
        allOf(
