...
abstract class HtmlReporter<T extends FileReport, P> extends Reporter<T, P> {
  ...
  Future<void> copyResources() async {
    const resources = [
      'package:ac_code_metrics/src/reporters/resources/variables.css',
      'package:ac_code_metrics/src/reporters/resources/normalize.css',
      'package:ac_code_metrics/src/reporters/resources/base.css',
      'package:ac_code_metrics/src/reporters/resources/main.css',
    ];
